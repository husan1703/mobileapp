...
const line1 = JudglLine(squaresArray, ["a_1", "a_2", "a_3"]);
const line2 = JudglLine(squaresArray, ["b_1", "b_2", "b_3"]);
const line3 = JudglLine(squaresArray, ["c_1", "c_2", "c_3"]);
const line4 = JudglLine(squaresArray, ["a_1", "b_1", "c_1"]);
const line5 = JudglLine(squaresArray, ["a_2", "b_2", "c_2"]);
const line6 = JudglLine(squaresArray, ["a_3", "b_3", "c_3"]);
const line7 = JudglLine(squaresArray, ["a_1", "b_2", "c_3"]);
const line8 = JudglLine(squaresArray, ["a_3", "b_2", "c_1"]);

const lineArray = [line1, line2, line3, line4, line5, line6, line7, line8];
const lineRandom = cornerLine(squaresArray, ["a_1", "a_3", "c_1", "c_3"]);
let winningLine = null;

const msgtxt1 = '<p class="image"><img src ="img/penguins.jpg" width=61px></p><p class="text">Penguins Attack! (your turn)</p>';
const msgtxt2 = '<p class="image"><img src ="img/whitebear.jpg" width=61px></p><p class="text">WhiteBear Attack! (computer turn)</p>';
...
const msgtxt5 = '<p class="image"><img src ="img/penguins.jpg" width=61px><img src ="img/whitebear.jpg" width=61px height=61px></p><p class="text animate__bounceIn">Draw!!</p>';
...
function JudglLine(targetArray, idArray) {
